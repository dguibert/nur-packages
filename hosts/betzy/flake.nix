{
  ...
  inputs = {
    ...
    nixpkgs.url          = "github:dguibert/nixpkgs/fa4a95770278b56ca493bafc4496207b9b01eee5";
  ...
  in (flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
    ...
    deploy.nodes.betzy = {
      ...
      profiles.hm-dguibert-x86_64 = {
        user = "dguibert";
        sshUser = "dguibert";
        path = (nixpkgsFor "x86_64-linux").deploy-rs.lib.activate.custom self.homeConfigurations.x86_64-linux.home-dguibert-x86_64.activationPackage
          ''
            set -x
            export NIX_STATE_DIR=${self.legacyPackages.x86_64-linux.nixStore}/var/nix
