      ...
      installPhase =
        ...
        + ''
          ...
          if [ -e $ccPath/${targetPrefix}gcc ]; then
            ...
            wrap ${targetPrefix}armclang $wrapper $ccPath/armclang
        ...
        + optionalString cc.langFortran or false ''
          if [ -e ${targetPrefix}gfortran ]; then
          ...
          elif [ -e armflang ]; then
            wrap armflang $wrapper $ccPath/armflang
