  ...
  perSystem = {
    ...
    pkgs' = import "${inputs.nixpkgs}/pkgs/top-level/default.nix" {
      ...
      stdenvStages = args: let
        ...
        splitN = 4;
        #splitN = pkgs.lib.length bootStages;
        initBootStages = pkgs.lib.take splitN bootStages;
        # TODO check that splitN stage is stage2
        tailBootStage = pkgs.lib.drop (splitN + 1) bootStages;
      in
